...
import com.ezddd.common.remote.RemoteProxyFactoryRegistry;
import com.ezddd.common.utils.EzBeanUtils;
import com.ezddd.common.utils.EzStringUtils;
            ...
            try {
                ...
                if (!CollectionUtils.isEmpty(fieldList)) {
                    for (Field field : fieldList) {
                        ...
                        if (ezRemoting != null) {
                            Object injectBean = RemoteProxyFactoryRegistry.create(ezRemoting.rpcType(), field.getType());
                            field.set(bean, injectBean);
                        }
                    }
                }
